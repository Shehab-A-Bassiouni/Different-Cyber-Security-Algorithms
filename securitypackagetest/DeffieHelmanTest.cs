...
namespace SecurityPackageTest
{
    ...
    public class DiffieHellmanTest
    {
        ...
        public void DeffieHelmanTest1()
        {
            ...
            List<int> key = algorithm.Get_Keys(19, 2, 6, 13);
        ...
        {
            DiffieHellman algorithm = new DiffieHellman();
            List<int> key = algorithm.Get_Keys(353, 2, 97, 233);
        ...
        {
            DiffieHellman algorithm = new DiffieHellman();
            List<int> key = algorithm.Get_Keys(353, 3, 97, 233);
        ...
        {
            DiffieHellman algorithm = new DiffieHellman();
            List<int> key = algorithm.Get_Keys(541, 10, 50, 100);
